...
export class AuthService {
    ...
    constructor() { 
        const stsSettings = {
             ...
             * tokens happen.
             * This is not being used by Auth0 IDP because it uses the end_session_endpoint
             */
            // post_logout_redirect_uri: `${Constants.clientRoot}signout-callback`,
            /** This is needed the oidc-client when using Auth0. If we don't have this configuration,
             * then we will not get a JWT when logging in and we will get an error when logging out 
             */
            metadata: {
                issuer: `${Constants.stsAuthority}`,
                /** Audience parameter is required if we need to have an access_token
                 * in a form of JWT token instead of just an opaque string.
                 */
                authorization_endpoint: `${Constants.stsAuthority}authorize?audience=noyes-projects-api`,
